  ...
  return (
    <section className='max-w-7xl mx-auto'>
     <div>
      ...
      <p className='mt-2 text-[#666e75] text-[18px] max-w[500px]'>Create imaginative and visually stunning images generated by Dall-E AI and share them with the community.</p>
     </div>
     <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
      ...
      <div className='mt-10'>
       <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created a image you can share this with the community....!</p>
       <button type='submit'
